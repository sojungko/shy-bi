...
export function deleteImage(props) {
  ...
  return dispatch =>
    axios
      .post('/api/bio/delete_image', sending)
...
export function uploadImage(props) {
  return dispatch =>
    axios
      .post('/api/bio/upload_image', props)
      .then(({ data }) =>
        dispatch({ type: A.IMAGE_UPLOAD_SUCCESS, payload: data })
      )
      .catch(error => err(error));
}
