...
export function getAll({ username }, callback) {
...
export function postMessage({ senderID, receiverID, title, body }, callback) {
...
export function getOutbox({ username }, callback) {
...
export function toggleRead({ msgID }, callback) {
  return db
    .run(
...
export function getUnreadMsgs({ username }, callback) {
  return db
    .run(
