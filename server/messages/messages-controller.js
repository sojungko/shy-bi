...
import { getAll, postMessage, getOutbox, toggleRead, getUnreadMsgs } from './messages-model';
...
export function findAllMessages({ params }, res) {
 ...
 *
 * --------------------------------------------------------------- */
export function sendMessage({ body }, res) {
 ...
 *
 * --------------------------------------------------------------- */
export function sentMessages({ params }, res) {
...
export function readMsg({ body }, res) {
  toggleRead(body, data => res.json(data));
}

export function findUnreadMessages({ params }, res) {
